 ...
 */
    ...
    override fun onRequestPermissionsResult(
        ...
        if (grantResults.isEmpty() || grantResults[LOCATION_PERMISSION_INDEX] == PackageManager.PERMISSION_DENIED ||
            ...
            { //Show snackBar to ask the user to allow permission from setting and creating an intent to their
            Snackbar.make(
                ...
                .setAction(R.string.settings){
                    ...
                    intent.data = Uri.fromParts("package", BuildConfig.LIBRARY_PACKAGE_NAME, null)
